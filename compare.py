...
if __name__ == '__main__':
    ...
    # hs_optimizer = HS(10_000_000, 6, rosenbrock_boundaries, False, hmcr=0.8)
    # hs_population = hs_optimizer.init_population(100)
    # hs_optimizer.optimize(hs_population, rosenbrock_function)

    # mvmo_optimizer = MVMO(10_000_000, 6, rosenbrock_boundaries, False, mutation_size=1)
    # mvmo_population = mvmo_optimizer.init_population(1000)
